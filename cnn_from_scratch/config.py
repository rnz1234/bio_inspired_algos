...
PRINT_MAX_VALIDATION_ACC_AND_EPOCH = True
PRINT_WEIGHTS_PERIODIC = False #True
...
DEBUG_NUM_OF_LINES_READ_LIMIT = 4000 #1000 #4000 #8000
...
# learning control
USE_DATA_STD_PRE_PROCESS = False#True #True
...
USED_WEIGHT_UPDATE_RULE = WEIGHT_UPDATE_RULE.BASIC #WEIGHT_DECAY_L2 #WEIGHT_DECAY_L2
...
# graph
DEBUG_GRAPH_TRAINING_PROGRESS = True
